 ...
 */
$config['site_title']                 = "japetol.com";       // Site Title, example.com
$config['admin_email']                = "admin@japetol.com"; // Admin Email, admin@example.com
$config['default_group']              = 'pembeli';           // Default group, use name
